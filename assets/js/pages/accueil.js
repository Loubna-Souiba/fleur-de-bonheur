...
function obtenirCheminImage(nomImageProduit) {
    ...
    let srcImgComplet = `/fleur-de-bonheur/${chemin.join("/")}/${nomImageProduit}.jpg`;
...
function ajouterProduit() {
    const nouveauProduit = creerProduit("bouquet de mariage", 20, "Un bouquet raffiné, parfait pour célébrer l'union avec grâce et délicatesse.", obtenirCheminImage(" bouquet fleur"), false);
